...
class NPaySearch extends NPay
{
    ...
    public function rules()
    {
        return [
            ...
            [['date', 'date_from', 'date_to', 'order_data', 'order_data_from', 'order_data_to', 'order_num', 'order_data', 'base_doc_date', 'patient_fio', 'patient_phone', 'patient_birthday', 'login_key', 'login_fio', 'sender_id', 'sender_name', 'discount_card', 'discount_name', 'app_version', 'kkm', 'z_num'], 'safe'],
