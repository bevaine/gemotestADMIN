<?php
namespace backend\modules\wiki;
...
class Module extends \yii\base\Module implements \yii\base\BootstrapInterface
{
	 ...
	 */
	public $modelClass = 'app\modules\wiki\models\Wiki';

	/**
	 * @var string the class used for searching
	 */
	public $searchModelClass = 'app\modules\wiki\models\WikiSearch';

	/**
	 * @var string the query class
	 */
	public $queryClass = 'app\modules\wiki\models\WikiQuery';
